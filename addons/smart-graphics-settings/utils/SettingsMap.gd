...
var _screen_resolution := {
	"width": screen_width,
	"height": screen_height
} setget private_screen_res_setter, private_screen_res_getter
...
var directional_shadow_size: int = ProjectSettings.get_setting("rendering/quality/directional_shadow/size") setget set_directional_shadow_size
var directional_shadow_size_mobile: int = ProjectSettings.get_setting("rendering/quality/directional_shadow/size.mobile") setget set_directional_shadow_size_mobile
...
func private_screen_res_setter(param) -> void:
	printerr("Error: cannot assign directly to private field _screen_resolution. Use set_screen_resolution() instead.")
...
func set_anistropic_filter_level(level: int) -> void:
	if level <= 16 and _is_power_of_two(level):
		...
		anistropic_filter_level = ProjectSettings.get_setting("rendering/quality/filters/anisotropic_filter_level")
		return
...
func set_directional_shadow_size_mobile(size: int) -> void:
	...
	directional_shadow_size = ProjectSettings.get_setting("rendering/quality/directional_shadow/size.mobile")
